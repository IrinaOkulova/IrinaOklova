...
## Обо мне: 
Специалист с четырёхлетним опытом в технической поддержке и мониторинге систем связи. Быстро адаптируюсь к новым инструментам и задачам. Умею структурировать информацию, работать с документацией и находить системные ошибки.

В 2026 году прошла курс по тестированию ПО, получила сертификат, активно использую Postman, Jira, SQL, Git.

Ищу позицию Junior QA (ручное тестирование) с удалённой занятостью и конкурентной зарплатой, которая позволит покрывать текущие расходы и откладывать на развитие. Рассматриваю компании с чёткими карьерными треками и возможностью обучения — готова расти внутри одной команды годами, если это даёт стабильность и рост дохода.
